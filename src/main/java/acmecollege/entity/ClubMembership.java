...
// Do we need a mapped super class?  If so, which one?
public class ClubMembership extends PojoBase implements Serializable {
	private static final long serialVersionUID = 1L;

	//  Add annotations for M:1.  Changes to this class should cascade to StudentClub.
	@ManyToOne(cascade = CascadeType.ALL)
	@JoinColumn(name="club_id")
	private StudentClub club;

	//Add annotations for 1:1.  Changes to this class should not cascade to MembershipCard.
	@OneToOne
